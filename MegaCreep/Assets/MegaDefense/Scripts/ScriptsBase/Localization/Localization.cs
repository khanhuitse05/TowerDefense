...
public static class Localization
{
    ...
    static public string language
    {
        ...
        set
        {
            Utils.LogYellow("LanguageSelection: " + value);
            if (mLanguage != value)
            {
                mLanguage = value;
                LoadAndSelect(value);
    ...
    static public bool LoadCSV(TextAsset asset, bool merge = false) { return LoadCSV(asset.bytes, merge); }

    static bool LoadCSV(byte[] bytes, bool merge = false)
    {
