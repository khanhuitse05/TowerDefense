...
namespace TDTK
{
    public class BuildManager : MonoBehaviour
    {
        ...
        public static void ShowPlatform(bool _value) { instance._ShowPlatform(_value); }
        public void _ShowPlatform(bool _value)
        {
            gridBuild.SetActive(_value);
        }
        ...
        public static bool BuildTowerDragNDrop(UnitTower tower) { return instance._BuildTowerDragNDrop(tower); }
        ...
        public static bool BuildTower(UnitTower tower)
        {
            if (buildInfo == null)
            {
                return false;
                //"Select a Build Point First";
            }
            if (tower.type == _TowerType.Resource && !GameControl.IsGameStarted())
            {
                return false;
